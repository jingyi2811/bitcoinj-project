...
public class Wallet extends BaseTaggableObject
    ...
    private static class BalanceCompletableFutureRequest {
        public Coin value;
        public BalanceType type;
    }
    @GuardedBy("lock") private List<BalanceCompletableFutureRequest> balanceCompletableFutureRequests = Lists.newLinkedList();
    ...
    public CompletableFuture<Coin> getBalanceCompletableFuture(final Coin value, final BalanceType type){
        return CompletableFuture.supplyAsync(() -> {
            ...
            if (current.compareTo(value) >= 0) {
            	...
            	BalanceCompletableFutureRequest req = new BalanceCompletableFutureRequest();
                req.value = value;
                req.type = type;
                balanceCompletableFutureRequests.add(req);
            }
